...
statusline.section_filename = function()
  ...
  vim.api.nvim_set_hl(0, "NavicText", { fg = "#575757" })
  full_location = "%#NavicText#" .. full_location .. filename .. modified .. " " .. navic_location
