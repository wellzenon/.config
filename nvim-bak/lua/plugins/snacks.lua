...
return {
  ...
  keys = {
    ...
    { "<leader>ss", function() Snacks.picker.lsp_symbols() end, desc = "LSP Document Symbols" },
    ...
    init = function()
      vim.api.nvim_create_autocmd('User', {
        ...
        callback = function()
          ...
          Snacks.toggle.option('background', { off = 'light', on = 'dark', name = 'Dark Background' }):map '<f2>'
